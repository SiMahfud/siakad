...
<div class="container-fluid">
    ...
    <p class="mb-4">
        Menampilkan rekap absensi untuk anak Anda: <strong><?= esc($student['full_name']) ?></strong> (NIS: <?= esc($student['nis'] ?? 'N/A') ?>) <br>
        <a href="<?= site_url('ortu/absensi') ?>">&laquo; Kembali ke Pilihan Anak (jika ada)</a>
    </p>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="get" action="<?= site_url('ortu/absensi/anak/' . $selected_student_id_for_url) ?>">
                <div class="row">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="childAttendanceTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Tanggal</th>
                        ...
                        <?php if (!empty($attendanceData)) : ?>
                            ...
                            <?php foreach ($attendanceData as $att) : ?>
                                <tr>
                                    ...
                                    <td><?= esc(day_name_id(date('w', strtotime($att['attendance_date'])))) ?></td>
...
<script>
    // Helper function for day name (if not available globally from other script)
    if (typeof day_name_id !== 'function') {
    ...
    $(document).ready(function() {
        $('#childAttendanceTable').DataTable({
            responsive: true,
            dom: 'Bfrtip',
            buttons: [
