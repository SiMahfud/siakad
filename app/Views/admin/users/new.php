...
<?= $this->section('content') ?>
    ...
    <form action="<?= site_url('admin/users/create') ?>" method="post">
        ...
        <div class="form-group">
            <label>Status:</label>
            <div>
                <input type="radio" name="is_active" id="is_active_true" value="1" <?= old('is_active', '1') == '1' ? 'checked' : '' ?>>
                <label for="is_active_true" style="display:inline; font-weight:normal;">Active</label>
            </div>
            <div>
                <input type="radio" name="is_active" id="is_active_false" value="0" <?= old('is_active') == '0' ? 'checked' : '' ?>>
