...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><?= esc($title ?? 'Add New Subject') ?></h1>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="<?= site_url('admin/subjects') ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= (isset($validation) && $validation->hasError('subject_name')) ? 'is-invalid' : '' ?>"
                           name="subject_name" id="subject_name" value="<?= old('subject_name') ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= (isset($validation) && $validation->hasError('subject_code')) ? 'is-invalid' : '' ?>"
                           name="subject_code" id="subject_code" value="<?= old('subject_code') ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="is_pilihan" id="is_pilihan" class="form-select <?= (isset($validation) && $validation->hasError('is_pilihan')) ? 'is-invalid' : '' ?>" required>
                        <option value="0" <?= old('is_pilihan', '0') == '0' ? 'selected' : '' ?>>Wajib (Core)</option>
